...
dataset = load_dataset("AlignmentLab-AI/alpaca-cot-collection")
...
sysprompt = "Keyword = Hero"
askprompt = "does the keyword start with the letter h"

print("Before training\n")
generate_text(f"<|begin_of_text|><|start_header_id|>system<|end_header_id|>{sysprompt}<|eot_id|><|start_header_id|>user<|end_header_id|>{askprompt}<|eot_id|><|start_header_id|>assistant<|end_header_id|>")
